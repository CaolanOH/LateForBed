class GameWinScene extends Phaser.Scene {
    ...
    init(data) {
        ...
        console.log("Game Win scene Started");
    ...
    create() {
        ...
        this.titleText = this.add.text(this.scaleW / 2.7, this.scaleH / 2.5, 'YOU WIN', {
            fontSize: '100px',
            fill: '#ffffff',
            fontFamily: 'Lato',
            fontWeight: 'bold',
        ...
        // create sound Icon
        this.soundButton = this.add.sprite(this.scaleW / 1.05, this.scaleH * 0.08, 'soundButton01');
    }
