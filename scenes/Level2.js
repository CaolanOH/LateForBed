class Level2 extends Phaser.Scene {
    ...
    createAudio() {
        // Adding Sounds
        this.music = this.sound.add('lvl2');
    ...
    createBackground() {
        //Background
        this.background = this.add.tileSprite(0, 0, game.config.width, game.config.height, "backgroundlvl2");
        this.background.setOrigin(0, 0);
        this.background.setScrollFactor(0);

        //Clouds
        this.clouds = this.add.tileSprite(0, 0, game.config.width, game.config.height, "clouds2");
        this.clouds.setOrigin(0, 0);
        this.clouds.setScrollFactor(0);

        //Hills2
        this.hills2 = this.add.tileSprite(0, -50, game.config.width, game.config.height, "hills2Lvl2");
        this.hills2.setOrigin(0, 0);
        this.hills2.setScrollFactor(0);

        //Hill1
        this.hills1 = this.add.tileSprite(0, -20, game.config.width, game.config.height, "hills1Lvl2");
        this.hills1.setOrigin(0, 0);
        this.hills1.setScrollFactor(0);

        // create sound Icon
        this.soundButton = new UiButton(this, this.scaleW / 1.05, this.scaleH * 0.08, 'soundButton01', 'soundButton02', this.toggleAudio.bind());
    ...
    createPlatforms() {
        ...
        //Platforms
        this.tilePlatform.create(1600, 300, 'platformlvl2');
        this.tilePlatform.create(1200, 550, 'platformlvl2');
        this.tilePlatform.create(2200, 550, 'platformlvl2');
        this.tilePlatform.create(3500, 450, 'platformlvl2');
        this.tilePlatform.create(4200, 350, 'platformlvl2');
        this.tilePlatform.create(5000, 550, 'platformlvl2');
    ...
    createGround() {
        ...
        this.platforms.create(750, 900, 'groundLvl2');

        //fake moving ground
        this.ground = this.add.tileSprite(0, 780, game.config.width, game.config.height, "groundLvl2");
